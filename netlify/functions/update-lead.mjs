...
export default async(request)=>{
 ...
 try{
  ...
  if(typeof b.leadCategory==='string'){const allowedCategories=new Set(['other','existing','emailed','unqualified']);if(!allowedCategories.has(b.leadCategory))throw new Error('Invalid lead category.');patch.lead_category=b.leadCategory;}
